				...
				<nav>
					<ul class="nav">
						...
						<?php if ($this->session->userdata('level')==1): ?>		
							<li><a href="<?=base_url('index.php/buku')?>" class="active"><i class="lnr lnr-home"></i> <span>Buku</span></a></li>
							<li><a href="<?=base_url('index.php/kategori')?>" class="active"><i class="lnr lnr-home"></i> <span>Kategori</span></a></li>
							<li><a href="<?=base_url('index.php/kasir')?>" class="active"><i class="lnr lnr-home"></i> <span>Kasir</span></a></li>							
							<li><a href="<?=base_url('index.php/transaksi')?>" class="active"><i class="lnr lnr-home"></i> <span>Transaksi</span></a></li>
						<?php else: ?>
							<li><a href="<?=base_url('index.php/transaksi')?>" class="active"><i class="lnr lnr-home"></i> <span>Transaksi</span></a></li>							
						<?php endif ?>
					</ul>
